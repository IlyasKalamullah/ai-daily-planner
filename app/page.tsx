  ...
  return (
    <main className="landing">
      <div className="landing-card">
        ...
        <p>Lihat jadwal Google Calendar kamu dan tanya apa saja lewat chat.</p>
        <ul>
          <li>Tampilan harian &amp; mingguan dari Google Calendar</li>
          <li>Tanya: &ldquo;Tanggal 12 ada jadwal apa?&rdquo;</li>
          <li>Tambah jadwal lewat chat, dengan konfirmasi</li>
        </ul>
